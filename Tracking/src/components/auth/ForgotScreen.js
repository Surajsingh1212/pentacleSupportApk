    ...
    return (
        <View className="w-full bg-[#f43439] ">
            ...
            <View className="bg-slate-50 w-screen rounded-tl-[150] h-[710] pt-[150] items-center">
                <Text className="text-3xl font-bold text-[#f43439]">FORGOT PASSWORD</Text>
                ...
                <TouchableOpacity className='bg-[#f43439] rounded-xl items-center w-[80%] mt-4' onPress={handleLoginPress}>
                    <Text className="text-[#ffffff] text-xl font-bold w-[80%] rounded-xl py-4 text-center">
                        Recover Now 
                    </Text>
                </TouchableOpacity>
                <Text className="text-xl mt-3">
                You have an password ? <Text className="text-[#f43439]" onPress={handleLoginPress}>Login Here</Text>
                </Text>
            </View>
        </View>
    )
